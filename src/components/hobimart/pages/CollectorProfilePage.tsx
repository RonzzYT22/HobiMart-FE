  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-10">
        {/* ── Profile Header Card ── */}
        <div className="bg-white rounded-2xl border border-[#E5E7EB] p-5 sm:p-8">
          <div className="flex flex-col sm:flex-row gap-5 sm:gap-7">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                  <div className="flex items-center gap-2.5 flex-wrap">
                    ...
                    <Badge className="bg-[#FF6B35]/10 text-[#FF6B35] border-[#FF6B35]/20 hover:bg-[#FF6B35]/15 font-semibold px-2.5 py-0.5 text-xs gap-1">
                ...
                <div className="flex items-center gap-2.5 sm:flex-shrink-0">
                  <Button
                    ...
                    className={`${
                      following
                        ? 'bg-white text-[#FF6B35] border-2 border-[#FF6B35] hover:bg-[#FF6B35]/5'
                        : 'bg-[#FF6B35] text-white hover:bg-[#E55A2B]'
                    } rounded-xl font-semibold px-5 h-10 text-sm shadow-none transition-all`}
                  >
                    {following ? 'Following' : 'Follow'}
                  </Button>
                  <Button
                    variant="outline"
                    className="rounded-xl font-semibold px-5 h-10 text-sm border-[#E5E7EB] text-[#1F2937] hover:bg-[#F8FAFC] hover:border-gray-300 shadow-none"
                  >
              ...
              {/* Stats Row */}
              <div className="flex items-center gap-4 sm:gap-6 mt-5 pt-5 border-t border-[#E5E7EB]">
                <div className="flex items-center gap-2">
                  <div className="w-9 h-9 rounded-lg bg-[#FF6B35]/10 flex items-center justify-center">
                    <Repeat className="w-4.5 h-4.5 text-[#FF6B35]" />
                  </div>
                  <div>
                    <p className="text-base font-bold text-[#1F2937]">127</p>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-base font-bold text-[#1F2937]">54</p>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-base font-bold text-[#1F2937]">84</p>
        ...
        <Tabs defaultValue="products" className="mt-6">
          <TabsList className="bg-white border border-[#E5E7EB] rounded-xl p-1 h-auto">
            <TabsTrigger
              value="products"
              className="rounded-lg px-4 py-2 text-sm font-medium data-[state=active]:bg-[#FF6B35] data-[state=active]:text-white data-[state=active]:shadow-sm data-[state=active]:shadow-orange-500/20 text-gray-500 data-[state=active]:border-transparent"
            >
              Products
            </TabsTrigger>
            <TabsTrigger
          ...
          <TabsContent value="collection" className="mt-5">
            <div className="bg-white rounded-2xl border border-[#E5E7EB] p-8 text-center">
              ...
              <Button
                ...
                className="mt-4 bg-[#FF6B35] text-white hover:bg-[#E55A2B] rounded-xl font-semibold text-sm shadow-none"
              >
                View All Items
              </Button>
            </div>
          ...
          <TabsContent value="reviews" className="mt-5">
            <div className="space-y-4">
              {collectorReviews.map((review) => (
                <div
                  key={review.id}
                  className="bg-white rounded-2xl border border-[#E5E7EB] p-5 sm:p-6 transition-shadow hover:shadow-md"
                >
                  ...
                  <div className="mt-3 flex items-center gap-2">
                    <Badge
                      variant="outline"
                      className="text-[11px] text-gray-400 border-[#E5E7EB] font-normal"
                    >
                    ...
                    {tradeHistory.map((trade) => (
                      ...
                      >
                        ...
                        <TableCell className="py-4 text-right">
                          <span
                            className={`inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-semibold border ${statusStyles[trade.status]}`}
                          >
                ...
                {tradeHistory.map((trade) => (
                  <div key={trade.id} className="p-4">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span
                        className={`inline-flex items-center px-2 py-0.5 rounded-lg text-[10px] font-semibold border ${statusStyles[trade.status]}`}
                      >
                        {trade.status}
                      </span>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0 text-right">
                        ...
                        <p className="text-sm font-medium text-[#FF6B35] truncate">
                          {trade.received}
                        </p>
                      </div>
                    </div>
