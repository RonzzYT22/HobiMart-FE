          ...
          <div className="flex flex-col">
            ...
            >
              ...
              <div className="text-left">
                              <p className="text-sm font-semibold text-[#1F2937] group-hover:text-[#FF6B35] transition-colors">{product.seller?.name ?? 'Unknown Seller'}</p>
                              <div className="flex items-center gap-2 text-xs text-gray-400">
                                ...
                                <span>·</span>
                                <span>{product.seller?.totalSales?.toLocaleString() ?? 0} sales</span>
                                <span>·</span>
                                <span>{product.seller?.positiveRate ?? 0}% positive</span>
                              </div>
                            </div>
